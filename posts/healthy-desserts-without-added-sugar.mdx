...
<section itemScope itemType="https://schema.org/FAQPage" className="space-y-4">
  <h2 className="text-xl font-semibold">FAQ About Healthy Desserts Without Added Sugar</h2>

  <details itemProp="mainEntity" itemScope itemType="https://schema.org/Question" className="border border-gray-300 rounded-md p-4 bg-white dark:bg-gray-900">
    <summary itemProp="name" className="font-bold cursor-pointer">1. What are healthy desserts without added sugar?</summary>
    <div itemProp="acceptedAnswer" itemScope itemType="https://schema.org/Answer" className="mt-2">
      <div itemProp="text">
  ...
  <details itemProp="mainEntity" itemScope itemType="https://schema.org/Question" className="border border-gray-300 rounded-md p-4 bg-white dark:bg-gray-900">
    <summary itemProp="name" className="font-bold cursor-pointer">2. What ingredients naturally sweeten sugar-free desserts?</summary>
    <div itemProp="acceptedAnswer" itemScope itemType="https://schema.org/Answer" className="mt-2">
      <div itemProp="text">
        ...
        <p className="mt-2">These ingredients add flavor, fiber, and moisture without spiking blood sugar.</p>
      </div>
    </div>
  </details>

  <details itemProp="mainEntity" itemScope itemType="https://schema.org/Question" className="border border-gray-300 rounded-md p-4 bg-white dark:bg-gray-900">
    <summary itemProp="name" className="font-bold cursor-pointer">3. What are examples of easy no-sugar desserts?</summary>
    <div itemProp="acceptedAnswer" itemScope itemType="https://schema.org/Answer" className="mt-2">
      <div itemProp="text">
        <ul className="list-disc list-inside space-y-1">
        ...
        <p className="mt-2">These recipes are quick, nutrient-dense, and often require no baking.</p>
      </div>
    </div>
  </details>

  <details itemProp="mainEntity" itemScope itemType="https://schema.org/Question" className="border border-gray-300 rounded-md p-4 bg-white dark:bg-gray-900">
    <summary itemProp="name" className="font-bold cursor-pointer">4. Are sugar-free desserts suitable for diabetics?</summary>
    <div itemProp="acceptedAnswer" itemScope itemType="https://schema.org/Answer" className="mt-2">
      <div itemProp="text">
